...
## 最終更新: 2026-04-30（作戦画面の改善・打順ドラッグ&ドロップで一段落）
...
**現状: 1 シーズンを「作戦 → 試合 → 結果 → 作戦」のループで通せるところまで到達**

### Phase 4: 永続化 + 複数シーズン化
- [ ] **データ永続化**（Hive または Isar）
  - シーズン途中の中断・再開
  - チーム / 選手 / シーズン進行 / 試合結果 / 統計の保存
- [ ] **複数シーズン化**: シーズン終了 → オフシーズン → 翌シーズン開始 のサイクル
- [ ] **選手の年齢と成長/衰え**: 成長タイプ（早熟/普通/晩成）でシーズン跨ぎに能力変動
- [ ] **引退**: 高齢 + 衰えで自動引退、ロースターから抜ける
- [ ] **ドラフト**: 新人選手生成 + 指名システムで補充
