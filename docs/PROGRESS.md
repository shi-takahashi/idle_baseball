...
## 最終更新: 2026-05-04（リアリティ調整セッション。シーズン試合数選択 (30/90/150)、失策数 2倍化、能力値分布の中央寄せ、能力ポテンシャル機能の追加、投手球速の NPB 水準化を実施）
...
- バント発生数のチューニング（やや多め）
- 犠飛の判定厳密化（外野フライで打点ありを全て犠飛扱いにしている）
- 個人「得点」集計（本塁を踏んだ選手を追跡）
- ラウンド順のシャッフル（前半・後半で対戦順を変える）
- 外野クッションエラー・送球エラーの実装（現状デッドコード or 未実装）
...
├── measure_errors.dart                 # 失策数を 5 シーズン平均で計測（NPB 水準比較）
