        ...
        builder: (context, _) {
          ...
          return ListView(
            ...
            children: [
              ...
              _SubscriptionCard(
                title: '時間スキップ',
                description: '試合結果を待たずに、何度でも続けて確認できます。',
                price: '月額 100 円',
                isPurchased: flags.hasTimeSkipSub,
              ),
              _SubscriptionCard(
                title: '広告を消す',
                description: '試合結果の前に流れる広告を非表示にします。',
                price: '月額 100 円',
                isPurchased: flags.hasAdRemovalSub,
              ),
              _SubscriptionCard(
                title: '能力の表示と編集',
                description: '選手の能力を表示し、自由に編集できるようになります。',
                price: '月額 100 円',
            ...
            Row(
              ...
              children: [
                ...
                if (isPurchased)
                  ...
                  FilledButton(
                    onPressed: () => _onPurchasePressed(context),
